...
class PuestosController extends Controller
{
     ...
     * My Service
     *
     * @var \App\Services\PuestosService
     */
    protected $service;
    ...
    {
        $this->service = new PuestosService();
    }

    /**
     * Retorna una lista de los recursos
     *
     * @param  \App\Http\Requests\Services\PuestosService\Index  $request
     ...
     *
     * @param  \App\Http\Requests\Services\PuestosService\Store  $request
     * @return \Illuminate\Http\JsonResponse
     */
     ...
     *
     * @param  \App\Http\Requests\Services\PuestosService\Show  $request
     * @return \Illuminate\Http\JsonResponse
     */
     ...
     *
     * @param  \App\Http\Requests\Services\PuestosService\Update  $request
     * @param  int  $id
     * @return \Illuminate\Http\JsonResponse
     */
     ...
     *
     * @param  \App\Http\Requests\Services\PuestosService\Destroy  $request
     * @return \Illuminate\Http\JsonResponse
     */
